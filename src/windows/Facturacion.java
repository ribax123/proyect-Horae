...
public class Facturacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNumeroFactura.setForeground(new java.awt.Color(0, 51, 204));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 10, 50, 40));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 10, 50, 40));
        ...
        jPanel1.add(btnProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 60, 110, 110));

        btnGuardarImprimir.setBackground(new java.awt.Color(0, 153, 153));
        btnGuardarImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/imprimir.png"))); // NOI18N
        jPanel1.add(btnGuardarImprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 190, 110, 110));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 330, 110, 110));
    ...
    public static void main(String args[]) {
        ...
        Facturacion num = new Facturacion();

        System.out.println(num.codigoIn());
